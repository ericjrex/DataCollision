...
<%
	...
	//arcgis
	request.setAttribute("arcgisPath", "/arcgis");
	request.setAttribute("arcgisVersionPath", "/arcgisVersion");
%>
...
<script type="text/javascript">
	...
	//arcgis
	window.$arcgisPath = "${arcgisPath}";
	window.$arcgisVersionPath = "${arcgisVersionPath}";
