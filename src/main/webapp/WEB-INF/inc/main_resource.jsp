...
<%-- <link type="text/css" rel="stylesheet" href="${appStaticsPath}/css/easyui/easyui.css"/> --%>
...
<link href="${appStaticsPath}/css/commons.css" rel="stylesheet" type="text/css" />
<!-- 平台业务应用 -->
...
<!-- chosen组件 -->
<link rel="stylesheet" type="text/css" href="${mwareStaticsPath}/jquery/jquery-zzui-1.0.0/zzchosen/zzchosen.css" />
<script type="text/javascript" src="${mwareStaticsPath}/jquery/jquery-zzui-1.0.0/zzchosen/zzchosen.jquery.js"></script>